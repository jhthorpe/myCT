PROGRAM ct
  ...
  REAL(KIND=4) :: Etol,Eint,t1,t2,T,Emax,dE
  INTEGER :: i,j,k
  ...
  CALL input(nvib,Eelc,Etol,Wi,names,Eint,mqm,options,Ngues,T,Emax,dE,nX)
  IF (options(2) .NE. 0) CALL stat_model(Emax,dE,nX,T,options,nvib,Wi)
